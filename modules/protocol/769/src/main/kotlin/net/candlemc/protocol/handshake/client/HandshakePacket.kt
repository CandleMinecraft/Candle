...
class HandshakePacket(
    ...
    val codec: AbstractDataCodec,
) : Packet769(
    0x00u,
    serializeHandshakeData(protocolVersion, serverAddress, serverPort, nextState, codec),
    ConnectionState.HANDSHAKING
) {
    constructor(id: UByte, length: Int, data: ByteArray, codec: AbstractDataCodec) : this(
        deserializeHandshakePacket(data.inputStream(), codec)
    )

    private constructor(packet: HandshakePacket) : this(
