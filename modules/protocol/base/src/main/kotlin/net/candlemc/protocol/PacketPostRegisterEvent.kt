 ...
 */
data class PacketPostRegisterEvent(val registry: PacketRegistry, val key: PacketKey, val factory: QuadFunction<UByte, Int, ByteArray, AbstractDataCodec, out Packet>) :
